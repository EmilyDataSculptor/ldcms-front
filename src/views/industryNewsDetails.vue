    ...
    <section class="neinav">
      <div class="con1400">
        <div class="neinav_item flexrow">
          <ul class="flexrow">
                        <li class="">
              <a href="/newsCenter" title="公司新闻">公司新闻</a>
            </li>
                        <li class="active">
...
<script>
  ...
  export default {
    ...
    methods: { 
      ...
      selectAllByIndustryNews() {  
        axios.get(this.baseUrl+'industryNews/selectAllByIndustryNews',{ 
      })
        .then(response => {  
            // 处理成功响应，例如显示成功消息  
    ...
    updateArticle(product){
      this.$router.push(`/industryNewsDetails?id=${product.id}`)
      this.$router.go(0); 
    },

    downPages(){
      let  downPagePosition=this.nextId;
      this.$router.push(`/industryNewsDetails?id=${downPagePosition}`)
      this.$router.go(0); 
    },

    upPages(){
      let  upPagePosition=this.previousId;
      this.$router.push(`/industryNewsDetails?id=${upPagePosition}`)
      this.$router.go(0);
    },
    ...
    selectListById() {  
          ...
          this.id=id;
          axios.get(this.baseUrl+`industryNews/selectListById?id=${this.id}`,{ 
    })
          .then(response => {  
