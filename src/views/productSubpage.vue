          ...
          <div class="head flexrow">
            <div class="logo">
              <a class="flexrow" href="/">
                <img src="../ldcms2024/images/indexLogo2.png" alt="New Point Education" style="height: 100px;">
              </a>
            </div>
            <div class="head_r flexrow">
              ...
              <div class="top_r flexrow">
                <div class="top_lang flexrow">
                  <img src="../ldcms2024/images/langico.png" alt>
                  <div class="langitem">
                                        <a class="flexrow"
                      href="/?lg=zh-cn">
                  ...
                  <div class="searchitem">
                    <div class="con1400">
                      <form class="searchform flexrow" method="get"
                        action="/contactUs">
                        <input type="text" name="search" placeholder="Please enter keywords">
                        <input  name="cid" type="hidden" value="128,144,147,203,200,197">
      ...
      <div class="waptop_item">
        <div class="con1400">
          <div class="waptopitem flexrow">
            <div class="waptop_l">
              <a class="flexrow" href="/">
                <img src="../ldcms2024/images/logo2.png" alt="New Point Education">
              </a>
            </div>
            <div class="waptop_r flexrow">
              <div class="waptop_lang flexrow">
                <p class="waptop_langa"  >CN</p>
                <div class="langitem">
                                    <a class="flexrow"
                    href="/?lg=zh-cn">
                    <img src="../ldcms2024/images/zh-cn.png" alt="简体中文">
            ...
            <div class="wapsearch">
              <div class="wapsea_item flexrow">
                <form class="flexrow" method="get"
                  action="/contactUs">
                  <input type="text" name="search" id placeholder="Please enter keywords">
                  <input  name="cid" type="hidden" value="128,144,147,203,200,197">
                  <button type="submit">
                    <img src="../ldcms2024/images/searchico.png" alt>
                  </button>
    ...
    <section class="neinav">
      <div class="con1400">
        <div class="neinav_item flexrow">
          <ul class="flexrow">
                        <li class="">
              <a href="/product" title="产品系列1">产品系列1</a>
            </li>
                        <li class=" active ">
              <a href="/productSubpage" title="产品系列2">产品系列2</a>
            </li>
                      </ul>
          <div class="casetop_r">
            <p>
          ...
          <div class="prolist_item flexrow">
            ...
            data-animate="fadeInUp" data-duration="1.5s" data-delay="0.1s">
              ...
              <div class="prolist2_tsx_r">
                <ul class="flexrow">
                  <li>
                     <a href="/productSubpage" :style="{backgroundColor:clickChangeColour}" @click="toggleAllBlue"> 
                            全部
                        </a></li>
                                    
                  <li v-for="product in responseColour" :key="product.id">
                            <a href="#"  @click.prevent="selectListByColourTap(product)" :style="{backgroundColor:product.color}">
                               {{ product.colour }}
                            </a>
                          </li>                  
                         </ul>
              ...
              <div class="prolist2_tsx_r">
                <ul class="flexrow">
                  <li>
                          <a class="flexrow" href="/productSubpage" :style="{backgroundColor:clickChangeType}" @click="toggleAllBlue">
                           全部
                          </a></li>
                  <li v-for="product in responseType" :key="product.id">
                            <a class="flexrow" href="#"  @click.prevent="selectListByTypeTap(product)" :style="{backgroundColor:product.color}">
                                {{ product.type }}
                            </a>
                          </li>
                       </ul>
            ...
            <div class="prolist_r prolist2_r animate"
              ...
              <div class="prolist_list container">
                <ul class="row">
                  ...
                  <li v-for="product in products" :key="product.id" class="col-lg-3 col-md-3 col-sm-6 col-xs-12">  
                <div @click="$router.push(`/productSubpageByDetails?id=${product.id}`)"  :title="product.mainTitle">  
                  ...
                  <div class="prolist_item_text flexrow">  
                    ...
                    <img src="../ldcms2024/images/rightArrow.png" alt="" style="height: 30px;"> 
                  </div>  
                </div>  
              </li>  
            </ul>
...
<script>
  ...
  export default {
    ...
    this.selectByDistinctColour();
    this.selectByDistinctType();
    }, 

    methods:{

      selectListByProduct() {  
      axios.get(this.baseUrl+'product/selectListByProduct',{
        params: {  
    ...
    handleSizeChange(val) {  
      ...
      if(this.methodCalledByColour===0){
          ...
          this.selectListByColour();
     }
     else if(this.methodCalledByColour===2){
    ...
    handleCurrentChange(val) {  
     ...
     this.currentPage =1;
      ...
      //点击侧边栏  
    selectListByColourTap(product){
      this.colour = product.colour
      this.responseColour.forEach(e=>e.color = '')
      this.responseType.forEach(e=>e.color = '')
      product.color = 'aqua'
      this.clickChangeType='aqua'
      this.selectListByColour()
    },
    selectListByColour() {  
      axios.get(this.baseUrl+`product/selectListByColour?colour=${this.colour}`,{
        params: {  
          currentPage: this.currentPage,  
          pageSize: this.pageSize, 
        },  
      }).then(response => { 
        console.log('后端返回Colour数据', response.data); 
        this.products = response.data.data
        this.total = Number(response.data.msg.split("_")[1]); 
        this.paginatedData = response.data.data;

        this.methodCalledByColour=1;
        console.log("this.methodCalledByColour",this.methodCalledByColour);
        this.toggleAllBlue();
    ...
    toggleAllBlue() {
      if(this.clickChangeColour==='aqua'){
        this.clickChangeColour='white';
        }
    },   

    toggleAllBlueByType() {
      if(this.clickChangeType==='aqua'){
        this.clickChangeType='white';
        } 
      },

    selectByDistinctColour() {  
      axios.get(this.baseUrl+'product/selectByDistinctColour',{ 
      }).then(response => { 
        // console.log('后端返回DistinctColou数据', response.data); 
        this.responseColour=response.data.data;
      }).catch(error => {  
       console.error(error);  
    });
      ...
      selectListByTypeTap(product){
      this.type = product.type
      this.responseColour.forEach(e=>e.color = '')
      this.responseType.forEach(e=>e.color = '')
      product.color = 'aqua'
      this.clickChangeColour='aqua'
      this.selectListByType()
    },

    selectListByType() {  
      axios.get(this.baseUrl+`product/selectListByType?type=${this.type}`,{
        params: {  
          currentPage: this.currentPage,  
          pageSize: this.pageSize, 
        }, 
      }).then(response => { 
        console.log('后端返回Type数据', response.data); 
        this.products = response.data.data
        this.total = Number(response.data.msg.split("_")[1]); 
        this.paginatedData = response.data.data;
        
        this.methodCalledByColour=2;
        this.toggleAllBlueByType();
    ...
    selectByDistinctType() {  
      axios.get(this.baseUrl+'product/selectByDistinctType',{ 
      }).then(response => { 
        this.responseType=response.data.data;
      }).catch(error => {  
       console.error(error);  
    });
