            ...
            <div class="con1400">
              <div class="procon1_item flexrow">
                <div class="procontent1_l">
                    ...
                    <div class="block">
                      <el-carousel height="550px" style="width: 100%;">
                        <el-carousel-item v-for="(imageUrl, index) in imageUrls" :key="index">
                          <img :src="imageUrl" alt="图片" class="carousel-image">  
                        </el-carousel-item>
                      </el-carousel>
                    </div>
                ...
                <div class="procontent1_r">
                  <div class="procont_ltop">
                    <!-- <h2>{{ response.data.data[0].colour }}</h2> -->
                    <h2>{{response.mainTitle}}</h2>
                  ...
                  <div class="procontent_zx">
                    <a class="flexrow" href>
                      <img src="../ldcms2024/images/zxzx.png" alt>
                      <span>在线咨询</span>
                    </a>
                  </div>
                </div>
            ...
            <div class="con1400">
              <div class="prodecon_item" id="procpxq">
                ...
                <div class="prodecon_itemcon">
                  <p>{{response.productDetails}}</p> 
                    
<p>
  <img :src="response.indexPicture" alt="" width="100%" />
</p>                 
                </div>
              </div>
              ...
              <div class="proxgtjlist"> 
                ...
                <el-carousel :interval="4000" type="card" height="400px">
                  <el-carousel-item v-for="product in listProduct.slice(0, 6)" :key="product.id">
                    <div @click="updateArticle(product)"  :title="product.mainTitle">
                      <div class="proxgtj_liimg">  
                        <img :src="product.indexPicture" style="width: 100%; height: 100%;" /> 
                      </div>  
                    </div>  
                    </el-carousel-item>
                  </el-carousel>
...
<script>
  ...
  computed: {  
  displayedProducts() {  
    return this.listProduct ? this.listProduct.slice(0, 6) : [];  
  }  
  },
    methods: { 

      productDetails() {  
      axios.post(this.baseUrl+'product/selectListById',{ 
          id:this.$route.query.id
          
      })  
    .then(response => {  
          // 处理成功响应，例如显示成功消息 
        console.log('后端product返回数据', response.data); 
    ...
    updateArticle(product){
     ...
     pictureUrl(){
        const imagePathString = this.response.picture;
        // 使用split(',')方法将字符串分割成数组  
        this.imageUrls = imagePathString.split(','); 
    ...
    .then(response => {  
          // 处理成功响应，例如显示成功消息 
        console.log('后端所有产品返回数据', response.data); 
        this.listProduct = response.data.data;
        console.log('所有产品', this.listProduct); 
        this.productDetails(); 
        })
     .catch(error => {  
      // 处理错误  
