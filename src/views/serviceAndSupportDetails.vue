        ...
        <div class="neinav_item flexrow">
          ...
          <div class="casetop_r">
            <p>
              ...
              <a href="/serviceAndSupport">服务与支持</a> 
                            >
              <a href="/serviceAndSupportDetails">服务案例</a> 
                          </p>
          </div>
        </div>
      </div>
          ...
          data-animate="fadeInLeft" data-duration="1.5s" data-delay="0.1s">
            ...
            <div class="newsde_ltime flexrow">
              <div class="newsdel_left">
                <p>
                                    <a href="/serviceAndSupportDetails#fashzr">#服务案例</a>
            ...
            <div class="newsde_lcontent">
              ...
              <el-button round @click="upPages()">上一页</el-button>
                            ...
                            <div class="newdelb_m">
                <a href="/serviceAndSupport">返回列表</a>
              </div>
...
<script>
  ...
  export default {
    ...
    created() {
        ...
        this.selectServiceAndSupportById();
    },
    ...
    updateArticle(product){
      this.$router.push(`/serviceAndSupportDetails?id=${product.id}`)
      this.$router.go(0); 
    },

    downPages(){
      let  downPagePosition=this.nextId;
      this.$router.push(`/serviceAndSupportDetails?id=${downPagePosition}`)
      this.$router.go(0);
    },

    upPages(){
      let  upPagePosition=this.previousId;
      this.$router.push(`/serviceAndSupportDetails?id=${upPagePosition}`)
      this.$router.go(0);
    },

    selectServiceAndSupportById() {  
          const id = this.$route.query.id; 
          this.id=id;
          axios.get(this.baseUrl+`serviceAndSupport/selectServiceAndSupportById?id=${this.id}`,{ 
    })
          .then(response => {  
              // 处理成功响应，例如显示成功消息 
